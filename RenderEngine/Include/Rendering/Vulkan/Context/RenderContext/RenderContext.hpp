	...
	*/
	...
	public:
		...
		*/
		...
		bool CreateCubemap(const RenderEngine::Assets::RawTexture& _input, RenderEngine::Assets::Texture* _output);
		...
		std::vector<char> GetTextureContent(RenderEngine::Assets::Texture* _texture);
