#ifndef RENDERENGINE_SHADER_BLINNPHONGFRAGMENT
#define RENDERENGINE_SHADER_BLINNPHONGFRAGMENT
...
float4 main(PSInput _input) : SV_TARGET
{
    ...
    for (int i = 0; i < LIGHT_COUNT; i++)
    {
        ...
        if (element.enable == true)
        {
            ...
            color += ComputeBlinnPhongLighting(light, material, normal, viewDirection, albedo, metalness);
        }
    }
